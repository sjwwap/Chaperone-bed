    ...
    <div class="returnBox">
      <div class="useproBoxLi useproBoxLifiex">
        ...
        <div class="userProQuest">
          <mu-button
            ...
            color="primary"
            small
          >　我要借床<span class="iconfont icon-xiangyou-copy"></span>　</mu-button>
        </div>
      </div>
      ...
      <div class="useproBoxLi useproBoxLiSelect">
        <div @click="useproBoxLiSH">
          ...
          <div>
            <i
              :class="{useproBoxLiLeft:isuseproBoxLiLeft}"
              class="up iconfont icon-xiangyou-copy"
            ></i>
          </div>
        </div>
        <ul v-show="useproBoxLiShow">
          <label
            @click="useproBoxLiActive($event,index)"
      ...
      >
        <em>收费标准<br />
          ...
          <p
            v-if="paystate == 1"
            style="color:#009999;"
          >提示：恭喜您已交过押金了，赶紧体验吧~</p>
        </em>
      </div>
      <div
        class="useproBoxLi"
        v-if="Prodata2[0].isDeposit == 1"
      >
        <em>收费标准<br />
      ...
      <mu-dialog
        ...
        width="640px"
        max-width="90%"
        dialog-class="userProExplainDiong"
        :open.sync="userProExplain"
      >
        <img
